      ...
      <div class="user">
        ...
        <div class="user--profile__meta">
          <h3 class="user--name text-truncate">
            <span class="margin-right-smaller" style="font-family: 'bipermedium'!important;">{{ currentContact.name }}</span>
            <fluent-icon
              v-if="!isHMACVerified"
          ...
          <div class="conversation--header--actions text-truncate">
            <inbox-name style="font-family: 'biperegular'!important; color: #95928E!important;"
              v-if="hasMultipleInboxes"
              :inbox="inbox"
              class="margin-right-small"
            />
            <span
              v-if="isSnoozed" style="font-family: 'bipermedium'!important;"
              class="snoozed--display-text margin-right-small"
            >
              {{ snoozedDisplayText }}
            </span>
            <woot-button style="font-family: 'biperegular'!important;"
