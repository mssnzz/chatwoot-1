  ...
  <div :class="emptyClassName">
    ...
    >
      ...
      <div v-if="!allConversations.length">
        <img src="https://beautiful-curran.146-190-54-185.plesk.page/openchat/noconversation.svg" alt="No Chat" />
        <h3 style="font-family: 'biperbold';">Conversaciones</h3>

        <span style="font-family: 'bipermedium';">
      ...
      <div v-else-if="allConversations.length && !currentChat.id">
        <img src="https://beautiful-curran.146-190-54-185.plesk.page/openchat/noconversation.svg" alt="No Chat" />
        <h3 style="font-family: 'biperbold'; color: #2D2E2E">Conversaciones</h3>
        <span style="font-family: 'bipermedium';">{{ conversationMissingMessage }}</span>
      </div>
    </div>
  </div>
</template>
