<template>
  <div class="message-text--metadata" style="font-family: 'biperegular'!important;">
    <span
      class="time"
      :class="{
        'has-status-icon':
    ...
    <span v-if="showReadIndicator" class="read-indicator-wrap">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6" style="color: #00FF6C; width: 18px; height: 18px;" v-tooltip.top-start="$t('CHAT_LIST.MESSAGE_READ')">
