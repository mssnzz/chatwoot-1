<template>
  ...
  >
    ...
    <Avatar
      ...
      :class="thumbnailClass" style="color: #fff;"
      :size="avatarSize" :style="{backgroundColor: bgColor}" id="example-avatar"
    />
    <img
      v-if="badgeSrc"
      class="source-badge"
...
export default {
  ...
  computed: {
    ...
    bgColor(){
      ...
      var index = this.userNameWithoutEmoji.length % colors.length;
