<template>
  <div class="editor-root" style="font-family: 'biperegular'!important; color: #000!important;">
    <tag-agents
    ...
    />
    <div ref="editor"  style="font-family: 'biperegular'!important; color: #000!important;"/>
  </div>
</template>
