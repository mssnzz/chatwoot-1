<template>
  <div class="top-box" style="background-color: #fff!important; border-top-left-radius: 10px!important; border-top-right-radius: 10px!important;">
    <div class="mode-wrap button-group">
      <woot-button
        variant="clear"
        class="button--reply" style="margin: 4%;
    border-radius: 200px; font-family: 'biperegular';"
      ...
      <woot-button
        class="button--note" style="margin: 4%;
    border-radius: 200px; font-family: 'biperegular';"
        variant="clear"
...
.button-group {
  ...
  .button {
    ...
    z-index: 1;
    &.is-active {
      background: #FF4F00!important; color: #fff!important;
    }
  }
  ...
  .button--note {
    ...
    &.is-active {
      border-right: 1px solid var(--color-border);
      background: #FFC532!important; color: #fff!important;
    }
