<template>
  <footer v-if="isFooterVisible" class="footer">
    <div class="left-aligned-wrap">
      <div class="page-meta" style="font-family: 'biperegular'!important;">
        <strong style="font-family: 'biperegular'!important;">{{ firstIndex }}</strong>
        - <strong style="font-family: 'biperegular'!important;">{{ lastIndex }}</strong> de
        <strong style="font-family: 'biperegular'!important;">{{ totalCount }}</strong> elementos
      </div>
    </div>
