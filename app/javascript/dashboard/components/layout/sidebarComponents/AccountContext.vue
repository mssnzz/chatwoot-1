<template>
  <div
    class="account-context--group" style="color: #000!important; background-color: #fff; font-family: 'bipermedium'!important;"
    @mouseover="setShowSwitch"
    @mouseleave="resetShowSwitch"
  >
    {{ $t('SIDEBAR.CURRENTLY_VIEWING_ACCOUNT') }}
    <p class="account-context--name text-ellipsis" style="font-family: 'biperbold'!important;">
      {{ account.name }}
    </p>
    <transition name="fade">
      <div v-if="showSwitchButton" class="account-context--switch-group">
        <woot-button style="font-size: 16px!important; font-family: 'biperegular'!important; color: #334BFA!important;"
          variant="clear"
          size="tiny"
          class="switch-button"
