<template>
  ...
  >
    <slot />
    <div
      class="chat-list__top" style="padding-top: 3%!important"
      :class="{ filter__applied: hasAppliedFiltersOrActiveFolders }"
    >
      <h1 class="page-title text-truncate title" :title="pageTitle">
        {{ pageTitle }}
      </h1>
...
@font-face {
  ...
  src: url('../assets/font/sfpro-heavy.ttf');
}

.title{
  font-family: 'biperbold'!important;
}
