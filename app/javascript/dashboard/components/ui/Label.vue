<template>
  <div :class="labelClass" :style="labelStyle" :title="description">
    ...
    />
    <span v-if="!href" style="color: #000; font-family: 'bipermedium'!important; font-size: 14px;">{{ title }}</span>
    <a v-else :href="href" :style="anchorStyle" style="color: #000; font-family: 'bipermedium'!important; font-size: 14px;">{{ title }}</a>
    <button
      v-if="showClose"
