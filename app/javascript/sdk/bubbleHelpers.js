...
export const bubbleSVG =
  'M 120 20 c -49.7056 0 -90 40.2944 -90 90 c 0 49.7056 40.2944 90 90 90 v 30 c 0 0 73.9165 -36.2969 87.6172 -99.8437 c 0.2849 -1.1925 0.5453 -2.3906 0.7813 -3.5937 c 0.4098 -2.3273 0.8343 -4.6534 1.0742 -7.0508 c 0.034 -0.2928 0.0665 -0.5858 0.0977 -0.8789 c 0.2572 -2.8356 0.4297 -5.7011 0.4297 -8.6328 c 0 -49.7056 -40.2944 -90 -90 -90 z';
...
export const createBubbleIcon = ({ className, path, target }) => {
  ...
  bubbleIcon.setAttributeNS(null, 'width', '34');
  bubbleIcon.setAttributeNS(null, 'height', '34');
