<template>
  ...
  >
    <woot-button
      ...
      class="selector-button" style="font-family: 'biperegular'!important;"
    ...
    >
      <div class="selector-user-wrap">
        ...
        <div class="selector-name-wrap">
          <h4
            v-if="!hasValue"
            class="not-selected text-ellipsis text-block-title" style="font-family: 'bipermedium'!important;"
          >
            {{ multiselectorPlaceholder }}
          </h4>
          <h4
            v-else
            class="selector-name text-truncate text-block-title" style="font-family: 'bipermedium'!important;"
