<template>
  ...
  >
    <div class="flex items-center">
      ...
      <div>
        <div
          class="font-medium text-base flex items-center" style="font-weight: 700!important; "
          :class="$dm('text-black-900', 'dark:text-slate-50')"
        >
        ...
        <div
          class="text-xs mt-1" style="font-weigth: 500!important; font-size: 13px!important"
